 ...
 */
public class GifViewerFrame extends JDialog {
        ...
        public GifViewerFrame(String imagePath) {
            this(imagePath, null);
        }

        public GifViewerFrame(Image image) {
            this(null, image);
        }

        private GifViewerFrame(String imagePath, Image image) {
        ...
        private void setListeners() {
            ...
            saveAsItem.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    chooser.showDialog(GifViewerFrame.this, "保存");
