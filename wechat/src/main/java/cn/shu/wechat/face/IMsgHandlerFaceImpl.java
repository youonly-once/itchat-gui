    ...
    private List<MessageTools.Result> controlCommandHandler(AddMsgList msg){
        ...
        switch (text){
            ...
            case "oauto":
                  ...
                  results.add(MessageTools.Result.builder().replyMsgTypeEnum(WXSendMsgCodeEnum.TEXT)
                                .msg("已开启【"+remarkNameByGroupUserName+"】自动回复功能")
                                .toUserName(toUserName).build());
            ...
            case "cauto":
                ...
                results.add(MessageTools.Result.builder().replyMsgTypeEnum(WXSendMsgCodeEnum.TEXT)
                        .msg("已关闭【"+remarkNameByGroupUserName+"】自动回复功能")
                        .toUserName(toUserName).build());
            ...
            case "opundo":
                    ...
                    results.add(MessageTools.Result.builder().replyMsgTypeEnum(WXSendMsgCodeEnum.TEXT)
                            .msg("已开启【"+remarkNameByGroupUserName+"】防撤回功能")
                            .toUserName(toUserName).build());
            ...
            case "cpundo":
                    ...
                    results.add(MessageTools.Result.builder().replyMsgTypeEnum(WXSendMsgCodeEnum.TEXT)
                            .msg("已关闭【"+remarkNameByGroupUserName+"】防撤回功能")
                            .toUserName(toUserName).build());
