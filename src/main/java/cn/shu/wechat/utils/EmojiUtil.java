...
public final class EmojiUtil {
    ...
    public static ImageIcon getWeChatEmoji(Object context,String code,int width,int height) {
        ...
        if (i == -1){
            i = wechatEmojiListZh.indexOf(code);
            if (i == -1) {
                return null;
            }
        }
