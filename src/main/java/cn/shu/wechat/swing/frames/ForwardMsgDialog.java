...
public class ForwardMsgDialog extends JDialog {
    ...
    public static ForwardMsgDialog getContext() {
        return context;
    }
    ...
    private void forwardMsg() {
        try {
            new SwingWorker<Object, Object>() {
                private WebWXSendMsgResponse wxCreateRoomResp;
                private List<SelectUserData> successList = new ArrayList<>();
