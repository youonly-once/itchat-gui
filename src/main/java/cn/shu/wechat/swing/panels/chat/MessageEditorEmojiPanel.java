...
public class MessageEditorEmojiPanel extends JPanel {
    ...
    private void initData() {
        ...
        List<String> emojis = Arrays.asList("/::)",     //微笑
                "/::~",     //撇嘴
                "/::B",     //色
                "/::|",     //发呆
                "/:8-)",     //得意
        ...
        String iconPath = "/emoji/qqface/";
        for (int i = 0; i < emojis.size(); i++) {
            JPanel panel = new MessageEditorExpressionItemPanel(emojis.get(i), IconUtil.getIcon(this,iconPath + i + ".png"), emojis.get(i));
